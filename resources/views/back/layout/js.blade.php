        ...
        <script src="{{asset('back/assets/libs/tinyeditor/tinymce.min.js')}}"></script>
        ...
        <!--Internal  Flot js-->
        <script src="{{asset('back/assets/plugins/jquery.flot/jquery.flot.js')}}"></script>
        <script src="{{asset('back/assets/plugins/jquery.flot/jquery.flot.pie.js')}}"></script>
        <script src="{{asset('back/assets/plugins/jquery.flot/jquery.flot.resize.js')}}"></script>
        <script src="{{asset('back/assets/plugins/jquery.flot/jquery.flot.categories.js')}}"></script>
        <script src="{{asset('back/assets/js/dashboard.sampledata.js')}}"></script>
        {{-- <script src="{{asset('back/assets/js/chart.flot.sampledata.js')}}"></script> --}}

        <!-- Custom Scroll bar Js-->
        <script src="{{asset('back/assets/plugins/mscrollbar/jquery.mCustomScrollbar.concat.min.js')}}"></script>
	...
	<script src="{{asset('back/assets/plugins/jquery-steps/jquery.steps.min.js')}}"></script>
	<script src="{{asset('back/assets/plugins/parsleyjs/parsley.min.js')}}"></script>

        <!--Internal  Perfect-scrollbar js -->
        <script src="{{asset('back/assets/plugins/perfect-scrollbar/perfect-scrollbar.min.js')}}"></script>
        <script src="{{asset('back/assets/plugins/perfect-scrollbar/p-scroll.js')}}"></script>
        ...
        <script src="{{asset('back/assets/js/form-wizard.js')}}"></script>


        <!-- Sticky js -->
        <script src="{{asset('back/assets/js/sticky.js')}}"></script>
        <script src="{{asset('back/assets/js/modal-popup.js')}}"></script>
	...
	<script src="{{asset('back/assets/js/form-validation.js')}}"></script>
	...
	<!-- Internal Data tables -->
        ...
        <script src="{{asset('back/assets/plugins/amazeui-datetimepicker/js/amazeui.datetimepicker.min.js')}}"></script>

        <!-- Ionicons js -->
        <script src="{{asset('back/assets/plugins/jquery-simple-datetimepicker/jquery.simple-dtpicker.js')}}"></script>
