...
@section('content')
    ...
    <div class="container-fluid">
            ...
            <div class="breadcrumb-header justify-content-between">
                <div class="my-auto">
                    <div class="d-flex">
                        <h4 class="content-title mb-0 my-auto">Form Create</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/Sub Procuct</span>
                    </div>
                </div>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('sub.product.store')}}" data-parsley-validate="" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="row row-sm">
