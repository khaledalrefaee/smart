...
@section('content')
    ...
    <div class="container-fluid">
            ...
            <div class="breadcrumb-header justify-content-between">
                <div class="my-auto">
                    <div class="d-flex">
                        <h4 class="content-title mb-0 my-auto">Form Edit </h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">{{$product->name_en}} /Sub Procuct</span>
                    </div>
                </div>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('sub.product.update',$product->id)}}" data-parsley-validate="" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="row row-sm">
                                ...
                                <div class="parsley-select col-lg-4 col-md-4" id="slWrapper">
                                    <label class="form-label">Sub Product: <span class="tx-danger">*</span></label>
                                    <select name="sub_product_id" id="sub_product_id" class="form-control select2" required>
                                        <option value="">Choose one</option>
                                    </select>
                                </div>
